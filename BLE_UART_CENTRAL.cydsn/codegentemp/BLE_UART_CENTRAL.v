// ======================================================================
// BLE_UART_CENTRAL.v generated from TopDesign.cysch
// 05/07/2017 at 14:21
...
module top ;
	...
	wire [0:0] tmpOE__Scan_LED_net;
	wire [0:0] tmpFB_0__Scan_LED_net;
	wire [0:0] tmpIO_0__Scan_LED_net;
	wire [0:0] tmpINTERRUPT_0__Scan_LED_net;
	electrical [0:0] tmpSIOVREF__Scan_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3899b5dc-effb-43d8-8853-66d82e684bc9"),
		  ...
		  .input_buffer_sel(2'b00))
		Scan_LED
		 (.oe(tmpOE__Scan_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Scan_LED_net[0:0]}),
		  .io({tmpIO_0__Scan_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Scan_LED_net),
		  .interrupt({tmpINTERRUPT_0__Scan_LED_net[0:0]}),
		  .annotation({Net_8}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Scan_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("e477dbe4-a418-464d-aad2-de4a22bbb484"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
