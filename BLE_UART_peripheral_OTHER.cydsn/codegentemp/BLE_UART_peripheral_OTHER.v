// ======================================================================
// BLE_UART_peripheral_OTHER.v generated from TopDesign.cysch
// 05/18/2017 at 15:18
...
module SCB_P4_v3_20_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("ad686cd1-183c-41b6-9f03-daff772a2156/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__Adv_LED_net;
	wire [0:0] tmpFB_0__Adv_LED_net;
	wire [0:0] tmpIO_0__Adv_LED_net;
	wire [0:0] tmpINTERRUPT_0__Adv_LED_net;
	electrical [0:0] tmpSIOVREF__Adv_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3899b5dc-effb-43d8-8853-66d82e684bc9"),
		  ...
		  .input_buffer_sel(2'b00))
		Adv_LED
		 (.oe(tmpOE__Adv_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Adv_LED_net[0:0]}),
		  .io({tmpIO_0__Adv_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Adv_LED_net),
		  .interrupt({tmpINTERRUPT_0__Adv_LED_net[0:0]}),
		  .annotation({Net_3171}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Adv_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a0ed618e-42a6-4ff8-99d3-ee93ea4fed45"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c2290dc5-282e-4ab6-b31e-6bb2e4504e10"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5bb14e90-bcbe-460a-857a-815700780c0d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
