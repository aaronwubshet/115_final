    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'B', (uint8)'L', (uint8)'E', (uint8)'_', (uint8)'S', (uint8)'e', (uint8)'r', (uint8)'i', (uint8)'a',
    (uint8)'l',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0014u, (void *)&cyBle_attValues[24] }, /* Server_UART_Tx_data */
    ...
    { 0x0014u, (void *)&cyBle_attValues[44] }, /* Server_UART_Rx_data */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x11u] = {
    ...
    { 0x000Eu, 0xCDD1u /* Server_UART_Tx_data                 */, 0x09100000u /* ntf    */, 0x000Fu, {{0x0014u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2803u /* Characteristic                      */, 0x00040001u /* wwr    */, 0x0011u, {{0x0010u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0011u, 0xCDD2u /* Server_UART_Rx_data                 */, 0x09040100u /* wwr    */, 0x0011u, {{0x0014u, (void *)&cyBle_attValuesLen[10]}} },
};
