...
/* Unconfigured pins */
#define UART_1_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define UART_1_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define UART_1_REMOVE_TX_SCL_MISO_PIN      (1u)
...
#define UART_1_REMOVE_UART_TX_PIN             (1u)
...
/* Unconfigured pins */
#define UART_1_RX_WAKE_SDA_MOSI_PIN (0u == UART_1_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define UART_1_RX_SDA_MOSI_PIN     (0u == UART_1_REMOVE_RX_SDA_MOSI_PIN)
#define UART_1_TX_SCL_MISO_PIN     (0u == UART_1_REMOVE_TX_SCL_MISO_PIN)
...
#if (UART_1_RX_WAKE_SDA_MOSI_PIN)
    #include "UART_1_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (UART_1_RX_SDA_MOSI) */

#if (UART_1_RX_SDA_MOSI_PIN)
    #include "UART_1_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (UART_1_RX_SDA_MOSI) */

#if (UART_1_TX_SCL_MISO_PIN)
    #include "UART_1_uart_tx_i2c_scl_spi_miso.h"
#endif /* (UART_1_TX_SCL_MISO) */
...
#if (UART_1_RX_SDA_MOSI_PIN)
    #define UART_1_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_1_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    
    #define UART_1_RX_SDA_MOSI_HSIOM_MASK      (UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_1_RX_SDA_MOSI_HSIOM_POS       (UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define UART_1_RX_SDA_MOSI_HSIOM_SEL_GPIO  (UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define UART_1_RX_SDA_MOSI_HSIOM_SEL_I2C   (UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define UART_1_RX_SDA_MOSI_HSIOM_SEL_SPI   (UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define UART_1_RX_SDA_MOSI_HSIOM_SEL_UART  (UART_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (UART_1_RX_WAKE_SDA_MOSI_PIN)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_MASK      (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_POS       (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define UART_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) UART_1_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (UART_1_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define UART_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) UART_1_INTCFG_TYPE_MASK << \
                                                                           UART_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins UART_1_RX_SDA_MOSI_PIN or UART_1_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (UART_1_RX_SDA_MOSI_PIN) */

#if (UART_1_TX_SCL_MISO_PIN)
    #define UART_1_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define UART_1_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    
    #define UART_1_TX_SCL_MISO_HSIOM_MASK      (UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define UART_1_TX_SCL_MISO_HSIOM_POS       (UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    #define UART_1_TX_SCL_MISO_HSIOM_SEL_GPIO  (UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define UART_1_TX_SCL_MISO_HSIOM_SEL_I2C   (UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define UART_1_TX_SCL_MISO_HSIOM_SEL_SPI   (UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define UART_1_TX_SCL_MISO_HSIOM_SEL_UART  (UART_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
#endif /* (UART_1_TX_SCL_MISO_PIN) */
...
/* Pins settings index. */
#define UART_1_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define UART_1_RX_SDA_MOSI_PIN_INDEX       (0u)
#define UART_1_TX_SCL_MISO_PIN_INDEX       (1u)
...
/* Pins settings mask. */
#define UART_1_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << UART_1_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define UART_1_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << UART_1_RX_SDA_MOSI_PIN_INDEX)
#define UART_1_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << UART_1_TX_SCL_MISO_PIN_INDEX)
...
#if (UART_1_TX_SCL_MISO_PIN)
    #define UART_1_CHECK_TX_SCL_MISO_PIN_USED \
                (UART_1_PIN_DM_ALG_HIZ != \
                    UART_1_GET_P4_PIN_DM(UART_1_uart_tx_i2c_scl_spi_miso_PC, \
                                                   UART_1_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (UART_1_TX_SCL_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define UART_1_SET_I2C_SCL_DR(val) \
                            UART_1_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define UART_1_SET_I2C_SCL_HSIOM_SEL(sel) \
                    UART_1_SET_HSIOM_SEL(UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   UART_1_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   UART_1_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define UART_1_WAIT_SCL_SET_HIGH  (0u == UART_1_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (UART_1_RX_SDA_MOSI_PIN)
    #define UART_1_SET_I2C_SCL_DR(val) \
                            UART_1_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define UART_1_SET_I2C_SCL_HSIOM_SEL(sel) \
                            UART_1_SET_HSIOM_SEL(UART_1_RX_SDA_MOSI_HSIOM_REG,  \
                                                           UART_1_RX_SDA_MOSI_HSIOM_MASK, \
                                                           UART_1_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define UART_1_WAIT_SCL_SET_HIGH  (0u == UART_1_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (UART_1_TX_SCL_MISO_PIN)
    #define UART_1_WAIT_SDA_SET_HIGH  (0u == UART_1_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Unconfigured pins */
#define UART_1_REMOVE_MOSI_SCL_RX_WAKE_PIN    UART_1_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define UART_1_REMOVE_MOSI_SCL_RX_PIN         UART_1_REMOVE_RX_SDA_MOSI_PIN
#define UART_1_REMOVE_MISO_SDA_TX_PIN         UART_1_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define UART_1_MOSI_SCL_RX_WAKE_PIN   UART_1_RX_WAKE_SDA_MOSI_PIN
#define UART_1_MOSI_SCL_RX_PIN        UART_1_RX_SDA_MOSI_PIN
#define UART_1_MISO_SDA_TX_PIN        UART_1_TX_SCL_MISO_PIN
...
#define UART_1_SS0_PIN                UART_1_RTS_SS0_PIN
    ...
    #define UART_1_MOSI_SCL_RX_WAKE_HSIOM_REG     UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_1_MOSI_SCL_RX_WAKE_HSIOM_PTR     UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_1_MOSI_SCL_RX_WAKE_HSIOM_MASK    UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_1_MOSI_SCL_RX_WAKE_HSIOM_POS     UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define UART_1_MOSI_SCL_RX_WAKE_INTCFG_REG    UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_1_MOSI_SCL_RX_WAKE_INTCFG_PTR    UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define UART_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  UART_1_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (UART_1_RX_WAKE_SDA_MOSI_PIN) */

#if (UART_1_MOSI_SCL_RX_PIN)
    #define UART_1_MOSI_SCL_RX_HSIOM_REG      UART_1_RX_SDA_MOSI_HSIOM_REG
    #define UART_1_MOSI_SCL_RX_HSIOM_PTR      UART_1_RX_SDA_MOSI_HSIOM_PTR
    #define UART_1_MOSI_SCL_RX_HSIOM_MASK     UART_1_RX_SDA_MOSI_HSIOM_MASK
    #define UART_1_MOSI_SCL_RX_HSIOM_POS      UART_1_RX_SDA_MOSI_HSIOM_POS
#endif /* (UART_1_MOSI_SCL_RX_PIN) */

#if (UART_1_MISO_SDA_TX_PIN)
    #define UART_1_MISO_SDA_TX_HSIOM_REG      UART_1_TX_SCL_MISO_HSIOM_REG
    #define UART_1_MISO_SDA_TX_HSIOM_PTR      UART_1_TX_SCL_MISO_HSIOM_REG
    #define UART_1_MISO_SDA_TX_HSIOM_MASK     UART_1_TX_SCL_MISO_HSIOM_REG
    #define UART_1_MISO_SDA_TX_HSIOM_POS      UART_1_TX_SCL_MISO_HSIOM_REG
...
#define UART_1_MOSI_SCL_RX_WAKE_PIN_INDEX UART_1_RX_WAKE_SDA_MOSI_PIN_INDEX
#define UART_1_MOSI_SCL_RX_PIN_INDEX      UART_1_RX_SDA_MOSI_PIN_INDEX
#define UART_1_MISO_SDA_TX_PIN_INDEX      UART_1_TX_SCL_MISO_PIN_INDEX
...
#define UART_1_MOSI_SCL_RX_WAKE_PIN_MASK UART_1_RX_WAKE_SDA_MOSI_PIN_MASK
#define UART_1_MOSI_SCL_RX_PIN_MASK      UART_1_RX_SDA_MOSI_PIN_MASK
#define UART_1_MISO_SDA_TX_PIN_MASK      UART_1_TX_SCL_MISO_PIN_MASK
