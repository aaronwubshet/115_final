...
uint8 SensorScan_Comp_initVar = 0u;

/* Internal functions definitoin */
static void SensorScan_Comp_trimAdjust(uint8 nibble) ;

/* static SensorScan_Comp_backupStruct  SensorScan_Comp_backup; */
#if (CY_PSOC5A)
    static SensorScan_Comp_LOWPOWER_BACKUP_STRUCT  SensorScan_Comp_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 SensorScan_Comp_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: SensorScan_Comp_Init
********************************************************************************
*
* Summary:
...
void SensorScan_Comp_Init(void) 
{
    ...
    SensorScan_Comp_SetSpeed(SensorScan_Comp_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( SensorScan_Comp_DEFAULT_HYSTERESIS == 0u )
        SensorScan_Comp_CR |= SensorScan_Comp_HYST_OFF;
    #else
        SensorScan_Comp_CR &= (uint8)(~SensorScan_Comp_HYST_OFF);
    #endif /* SensorScan_Comp_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( SensorScan_Comp_DEFAULT_PWRDWN_OVRD == 0u )
            SensorScan_Comp_CR &= (uint8)(~SensorScan_Comp_PWRDWN_OVRD);
        #else 
            SensorScan_Comp_CR |= SensorScan_Comp_PWRDWN_OVRD;
        #endif /* SensorScan_Comp_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    SensorScan_Comp_CR |= SensorScan_Comp_MX_AO;

    /* Set default sync */
    SensorScan_Comp_CLK &= (uint8)(~SensorScan_Comp_SYNCCLK_MASK);
    #if ( SensorScan_Comp_DEFAULT_BYPASS_SYNC == 0u )
        SensorScan_Comp_CLK |= SensorScan_Comp_SYNC_CLK_EN;
    #else
        SensorScan_Comp_CLK |= SensorScan_Comp_BYPASS_SYNC;
    #endif /* SensorScan_Comp_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: SensorScan_Comp_Enable
********************************************************************************
*
* Summary:
...
{
    SensorScan_Comp_PWRMGR |= SensorScan_Comp_ACT_PWR_EN;
    SensorScan_Comp_STBY_PWRMGR |= SensorScan_Comp_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(SensorScan_Comp_restoreReg == 1u)
        {
            SensorScan_Comp_CR = SensorScan_Comp_lowPowerBackup.compCRReg;

            /* Clear the flag */
            SensorScan_Comp_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: SensorScan_Comp_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  SensorScan_Comp_initVar: Is modified when this function is called for the 
...
void SensorScan_Comp_Start(void) 
{
    ...
    if ( SensorScan_Comp_initVar == 0u )
    {
        SensorScan_Comp_Init();
        
        SensorScan_Comp_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: SensorScan_Comp_Stop
********************************************************************************
*
* Summary:
...
void SensorScan_Comp_Stop(void) 
{
    ...
    SensorScan_Comp_PWRMGR &= (uint8)(~SensorScan_Comp_ACT_PWR_EN);
    SensorScan_Comp_STBY_PWRMGR &= (uint8)(~SensorScan_Comp_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        SensorScan_Comp_restoreReg = 1u;

        /* Save the control register before clearing it */
        SensorScan_Comp_lowPowerBackup.compCRReg = SensorScan_Comp_CR;
        SensorScan_Comp_CR = SensorScan_Comp_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: SensorScan_Comp_SetSpeed
********************************************************************************
*
* Summary:
...
void SensorScan_Comp_SetSpeed(uint8 speed) 
{
    ...
    SensorScan_Comp_CR = (SensorScan_Comp_CR & (uint8)(~SensorScan_Comp_PWR_MODE_MASK)) |
                           (speed & SensorScan_Comp_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == SensorScan_Comp_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            SensorScan_Comp_TR = SensorScan_Comp_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            SensorScan_Comp_TR0 = SensorScan_Comp_HS_TRIM_TR0;
            SensorScan_Comp_TR1 = SensorScan_Comp_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            SensorScan_Comp_TR = SensorScan_Comp_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            SensorScan_Comp_TR0 = SensorScan_Comp_LS_TRIM_TR0;
            SensorScan_Comp_TR1 = SensorScan_Comp_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: SensorScan_Comp_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( SensorScan_Comp_WRK & SensorScan_Comp_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: SensorScan_Comp_trimAdjust
********************************************************************************
*
* Summary:
...
static void SensorScan_Comp_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = SensorScan_Comp_WRK & SensorScan_Comp_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                SensorScan_Comp_TR |= SensorScan_Comp_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                SensorScan_Comp_TR0 |= SensorScan_Comp_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                SensorScan_Comp_TR |= SensorScan_Comp_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                SensorScan_Comp_TR1 |= SensorScan_Comp_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                SensorScan_Comp_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                SensorScan_Comp_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                SensorScan_Comp_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                SensorScan_Comp_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((SensorScan_Comp_WRK & SensorScan_Comp_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: SensorScan_Comp_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 SensorScan_Comp_ZeroCal(void) 
{
    ...
    tmpSW0 = SensorScan_Comp_SW0;
    tmpSW2 = SensorScan_Comp_SW2;
    tmpSW3 = SensorScan_Comp_SW3;

     /* Clear routing for inP, retain routing for inN */
    SensorScan_Comp_SW0 = 0x00u;
    SensorScan_Comp_SW2 = 0x00u;
    SensorScan_Comp_SW3 = tmpSW3 & (uint8)(~SensorScan_Comp_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = SensorScan_Comp_CR;
    SensorScan_Comp_CR |= (SensorScan_Comp_CAL_ON | SensorScan_Comp_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        SensorScan_Comp_TR = SensorScan_Comp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        SensorScan_Comp_TR0 = SensorScan_Comp_DEFAULT_CMP_TRIM;
        SensorScan_Comp_TR1 = SensorScan_Comp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (SensorScan_Comp_CR & SensorScan_Comp_PWR_MODE_MASK) == SensorScan_Comp_PWR_MODE_FAST)
    {
        SensorScan_Comp_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        SensorScan_Comp_trimAdjust(1u);
		SensorScan_Comp_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    SensorScan_Comp_CR = tmpCR;
    
    /* Restore routing registers for inP */
    SensorScan_Comp_SW0 = tmpSW0;
    SensorScan_Comp_SW2 = tmpSW2;
    SensorScan_Comp_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) SensorScan_Comp_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)SensorScan_Comp_TR1 << 8u) | (SensorScan_Comp_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: SensorScan_Comp_LoadTrim
********************************************************************************
*
* Summary:
...
void SensorScan_Comp_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: SensorScan_Comp_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: SensorScan_Comp_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
