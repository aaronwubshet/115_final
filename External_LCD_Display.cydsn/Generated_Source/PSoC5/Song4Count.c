...
{
    uint8 staticBits = (Song4Count_DR & (uint8)(~Song4Count_MASK));
    Song4Count_DR = staticBits | ((uint8)(value << Song4Count_SHIFT) & Song4Count_MASK);
}
...
{
	CyPins_SetPinDriveMode(Song4Count_0, mode);
	CyPins_SetPinDriveMode(Song4Count_1, mode);
	CyPins_SetPinDriveMode(Song4Count_2, mode);
	CyPins_SetPinDriveMode(Song4Count_3, mode);
}
...
{
    return (Song4Count_PS & Song4Count_MASK) >> Song4Count_SHIFT;
}
...
{
    return (Song4Count_DR & Song4Count_MASK) >> Song4Count_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Song4Count_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Song4Count_0_INTR) != 0u) 
		{ 
			 Song4Count_0_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Song4Count_1_INTR) != 0u) 
		{ 
			 Song4Count_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Song4Count_2_INTR) != 0u) 
		{ 
			 Song4Count_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Song4Count_3_INTR) != 0u) 
		{ 
			 Song4Count_3_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Song4Count_INTSTAT & Song4Count_MASK) >> Song4Count_SHIFT;
    }
