...
{
    uint8 staticBits = (Song1Trigger_DR & (uint8)(~Song1Trigger_MASK));
    Song1Trigger_DR = staticBits | ((uint8)(value << Song1Trigger_SHIFT) & Song1Trigger_MASK);
}
...
{
	CyPins_SetPinDriveMode(Song1Trigger_0, mode);
}
...
{
    return (Song1Trigger_PS & Song1Trigger_MASK) >> Song1Trigger_SHIFT;
}
...
{
    return (Song1Trigger_DR & Song1Trigger_MASK) >> Song1Trigger_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Song1Trigger_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Song1Trigger_0_INTR) != 0u) 
		{ 
			 Song1Trigger_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Song1Trigger_INTSTAT & Song1Trigger_MASK) >> Song1Trigger_SHIFT;
    }
